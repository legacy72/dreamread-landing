...
export const translations: AllTranslations = {
  en: {
    ...
    "hero.note.highlight": "Apple Watch required",
    "hero.note.text": "for sleep detection \u2022 Core playback works without Apple Watch",
    ...
    // Social proof
    "social.title": "Loved by Listeners",
    "social.subtitle": "Join thousands who fall asleep to audiobooks every night",
    "social.review1.text": "I used to lose my place every night. Now the app just stops when I'm out. Game changer.",
    "social.review1.author": "Mike T.",
    "social.review1.detail": "Apple Watch user",
    "social.review2.text": "Tried a few audiobook apps for bedtime, this is the only one that actually pauses on its own.",
    "social.review2.author": "Jessica L.",
    "social.review2.detail": "Premium subscriber",
    "social.review3.text": "Love that I can import my own files. The sleep timer is a nice backup too.",
    "social.review3.author": "David R.",
    "social.review3.detail": "Imports own audiobooks",
    "social.rating": "4.8 out of 5",
    "social.ratingLabel": "App Store Rating",
    ...
    "features.timer.desc": "Set a sleep timer - playback pauses automatically when time is up",
    "features.catalog.title": "Free Audiobook Catalog",
    ...
    "features.formats.desc": "Import MP3, M4A, M4B, FLAC, and other audio files with automatic progress saving",
    ...
    "how.step1.desc": "Import your own files or browse free books from LibriVox",
    ...
    "pricing.free.f7": "LibriVox free audiobook catalog",
    ...
    "pricing.premium.period.annual": "/ year",
    "pricing.premium.price.monthly": "$6.99",
    "pricing.premium.period.monthly": "/ month",
    "pricing.premium.trial": "7-day free trial included",
    "pricing.premium.save": "Save 52%",
    ...
    "support.faq.a3": "Tap the import button in the Library tab to open the Files app. You can import individual files or entire folders. DreamRead also includes a built-in catalog of free audiobooks via LibriVox.",
    ...
    "support.faq.a6": "Premium unlocks Sleep Detection via Apple Watch, advanced playback controls, unlimited listening stats, sleep session quality info, and unlimited books, bookmarks, and folders. Plans: $6.99/month or $39.99/year with a 7-day free trial.",
    ...
    "terms.subscriptions.plans": "Plans: Premium Monthly ($6.99/month) and Premium Annual ($39.99/year)",
  ...
  ru: {
    ...
    "hero.devices": "iPhone + Apple Watch",
    "hero.note.highlight": "Требуется Apple Watch",
    "hero.note.text": "для определения сна \u2022 Плеер работает и без Apple Watch",
    ...
    // Social proof
    "social.title": "Нас любят слушатели",
    "social.subtitle": "Присоединяйтесь к тысячам людей, которые засыпают под аудиокниги каждый вечер",
    "social.review1.text": "Раньше утром всегда искал, где остановился. Теперь приложение само ставит на паузу, когда засыпаю.",
    "social.review1.author": "Алексей В.",
    "social.review1.detail": "Пользователь Apple Watch",
    "social.review2.text": "Удобно, что можно закинуть свои файлы. Каталог LibriVox тоже норм для классики.",
    "social.review2.author": "Марина С.",
    "social.review2.detail": "Импортирует свои книги",
    "social.review3.text": "Перепробовал кучу плееров, этот единственный реально останавливается сам. Покупал премиум не раздумывая.",
    "social.review3.author": "Игорь Н.",
    "social.review3.detail": "Подписчик Premium",
    "social.rating": "4.8 из 5",
    "social.ratingLabel": "Оценка в App Store",
    ...
    "features.timer.desc": "Установите таймер сна - воспроизведение остановится автоматически",
    "features.catalog.title": "Бесплатный каталог аудиокниг",
    "features.catalog.desc": "Встроенный каталог LibriVox - слушайте без регистрации",
    "features.formats.title": "Все популярные форматы",
    "features.formats.desc": "Импорт MP3, M4A, M4B, FLAC и других аудиоформатов с автосохранением прогресса",
    ...
    "how.step1.desc": "Импортируйте свои файлы или выберите из бесплатных книг LibriVox",
    ...
    "pricing.free.f7": "Бесплатный каталог LibriVox",
    ...
    "pricing.premium.price.annual": "$39.99",
    "pricing.premium.period.annual": "/ год",
    "pricing.premium.price.monthly": "$6.99",
    "pricing.premium.period.monthly": "/ месяц",
    "pricing.premium.trial": "7 дней бесплатно",
    "pricing.premium.save": "Экономия 52%",
    ...
    "support.faq.a3": "Нажмите кнопку импорта на вкладке «Библиотека» - откроется приложение «Файлы». Можно импортировать отдельные файлы или целые папки. Также доступен встроенный каталог бесплатных аудиокниг от LibriVox.",
    ...
    "support.faq.a6": "Premium открывает определение сна через Apple Watch, расширенное управление воспроизведением, полную статистику, информацию о качестве сна и безлимит книг, закладок и папок. Тарифы: $6.99/мес или $39.99/год с 7-дневным пробным периодом.",
    ...
    "terms.subscriptions.plans": "Тарифы: Месячный ($6.99/мес) и Годовой ($39.99/год)",
