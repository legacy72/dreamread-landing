...
export const translations: AllTranslations = {
  en: {
    ...
    // Social proof
    "social.h2.a": "Listeners, ",
    "social.h2.b": "recorded.",
    "social.meta": "— Field notes · no. 001–003 —",
    "social.review1.src": "App Store — ★★★★★",
    "social.review1.text":
      "I used to lose my place every night. Now the app just stops when I drift off. A quiet, generous piece of software.",
    "social.review1.author": "Mike T.",
    "social.review1.detail": "Apple Watch user",
    "social.review2.src": "App Store — ★★★★★",
    "social.review2.text":
      "Tried a few audiobook apps for bedtime. This is the only one that actually pauses on its own. Embarrassing how much I've listened since.",
    "social.review2.author": "Jessica L.",
    "social.review2.detail": "Premium subscriber",
    "social.review3.src": "App Store — ★★★★★",
    "social.review3.text":
      "Love that I can import my own files. The sleep timer is a nice backup too. Treats bedtime like a ritual worth keeping.",
    "social.review3.author": "David R.",
    "social.review3.detail": "Imports own audiobooks",
    "stat.1.n": "1,000+",
    "stat.1.l": "Free classic titles",
    "stat.2.n": "4.8",
    "stat.2.l": "App Store rating",
    "stat.3.n": "9",
  ...
  ru: {
    ...
    // Social proof
    "social.h2.a": "Голоса ",
    "social.h2.b": "слушателей.",
    "social.meta": "— Полевые заметки · № 001–003 —",
    "social.review1.src": "App Store — ★★★★★",
    "social.review1.text":
      "Раньше каждое утро искал место, на котором остановился. Теперь приложение само ставит паузу, когда я засыпаю. Тихая, очень добрая программа.",
    "social.review1.author": "Алексей В.",
    "social.review1.detail": "Пользуется Apple Watch",
    "social.review2.src": "App Store — ★★★★★",
    "social.review2.text":
      "Перепробовала кучу аудиоплееров на ночь. Только этот действительно ставит паузу сам. Стыдно признаться, сколько книг я «дослушала» с тех пор.",
    "social.review2.author": "Марина С.",
    "social.review2.detail": "Подписчик Premium",
    "social.review3.src": "App Store — ★★★★★",
    "social.review3.text":
      "Здорово, что можно загружать свои файлы. Таймер сна — приятная подстраховка. Отход ко сну снова стал ритуалом, который хочется беречь.",
    "social.review3.author": "Игорь Н.",
    "social.review3.detail": "Слушает свою коллекцию",
    "stat.1.n": "1000+",
    "stat.1.l": "Бесплатных классических книг",
    "stat.2.n": "4.8",
    "stat.2.l": "Оценка в App Store",
    "stat.3.n": "9",
